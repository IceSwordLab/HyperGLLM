...
torchrun --nnodes 1 --nproc_per_node=4 --node_rank=0 --master_port=29900 train.py \
--datasets_path "../../datasets/" \
--datasets_name "TRAIN.json" \
--datasets_fnspath "../../datasets/" \
--datasets_fnsname "Families.json" \
--output_dir "./trainer_dir_paramS48HY4/" \
--model_path "/home/jovyan/h800ndr/shared/models/llama3/" \
