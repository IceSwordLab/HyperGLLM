...
--output_dir "./trainer_dir_paramS48HY4_d128/" \
...
--output_dir "./test_dir_paramS48HY4_d128/" \
--model_path "./trainer_dir_paramS48HY4_d128/" \
...
--datasets_fnspath "../../datasets/" \
--datasets_fnsname "Families.json" \
--output_dir "./trainer_dir_paramS48HY4_d256/" \
--model_path "/home/jovyan/h800fast/shared/models/Qwen/Qwen2_5/" \
--model_name "Qwen2.5-3B-Instruct" \
--deepspeed "" \
--system_prompt "" \
...
--datasets_path "../../datasets/" \
--datasets_name "TEST.json" \
--output_dir "./test_dir_paramS48HY4_d256/" \
--model_path "./trainer_dir_paramS48HY4_d256/" \
--model_name "checkpoint-30000" \
--system_prompt "" \
--template_prompt "From a computer security perspective, what are the behavior types of the following logs collected by an Endpoint Detection and Response (EDR) system?\n {input}" \
--is_training 0 \
...
--datasets_fnspath "../../datasets/" \
--datasets_fnsname "Families.json" \
--output_dir "./trainer_dir_paramS48HY4_d384/" \
--model_path "/home/jovyan/h800fast/shared/models/Qwen/Qwen2_5/" \
--model_name "Qwen2.5-3B-Instruct" \
--deepspeed "" \
--system_prompt "" \
...
--datasets_path "../../datasets/" \
--datasets_name "TEST.json" \
--output_dir "./test_dir_paramS48HY4_d384/" \
--model_path "./trainer_dir_paramS48HY4_d384/" \
--model_name "checkpoint-30000" \
--system_prompt "" \
--template_prompt "From a computer security perspective, what are the behavior types of the following logs collected by an Endpoint Detection and Response (EDR) system?\n {input}" \
--is_training 0 \
...
--datasets_fnspath "../../datasets/" \
--datasets_fnsname "Families.json" \
--output_dir "./trainer_dir_paramS48HY4_d640/" \
--model_path "/home/jovyan/h800fast/shared/models/Qwen/Qwen2_5/" \
--model_name "Qwen2.5-3B-Instruct" \
--deepspeed "" \
--system_prompt "" \
...
--datasets_path "../../datasets/" \
--datasets_name "TEST.json" \
--output_dir "./test_dir_paramS48HY4_d640/" \
--model_path "./trainer_dir_paramS48HY4_d640/" \
--model_name "checkpoint-30000" \
--system_prompt "" \
--template_prompt "From a computer security perspective, what are the behavior types of the following logs collected by an Endpoint Detection and Response (EDR) system?\n {input}" \
--is_training 0 \
